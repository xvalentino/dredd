...
TransactionRunner = (function() {
  ...
  TransactionRunner.prototype.executeTransaction = function(transaction, hooks, callback) {
    var base, base1, buffer, caseInsensitiveRequestHeadersMap, configuration, error, error1, handleRequest, key, message, ref, ref1, ref2, req, requestOptions, test, transport, value;
    if (!callback) {
      callback = hooks;
      hooks = null;
    }
    ...
    configuration.emitter.emit('test start', test, function() {});
    if (transaction['results'] == null) {
      transaction['results'] = {};
    }
    if ((base = transaction['results'])['general'] == null) {
    ...
    if (transaction.skip) {
      ...
      test['status'] = 'skip';
      configuration.emitter.emit('test skip', test, function() {});
      return callback();
      ...
      handleRequest = (function(_this) {
        return function(res) {
          ...
          res.on('error', function(error) {
            if (error) {
              configuration.emitter.emit('test error', error, test, function() {});
            }
            return callback();
          });
