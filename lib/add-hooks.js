...
var Hooks, addHooks, async, clone, fs, glob, logger, mergeSandboxedHooks, path, proxyquire, sandboxHooksCode;
...
addHooks = function(runner, transactions, callback) {
  var base, customConfigCwd, file, files, fixLegacyTransactionNames, globItem, globs, i, j, k, len, len1, len2, loadHookFile, loadSandboxHooksFromStrings, msg, ref, ref1, ref10, ref11, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, transaction, workerClientPath;
  ...
  if (!(runner != null ? (ref2 = runner.configuration) != null ? (ref3 = ref2.options) != null ? ref3.hookfiles : void 0 : void 0 : void 0)) {
    ...
    files = [];
    if ((runner != null ? (ref4 = runner.configuration) != null ? (ref5 = ref4.options) != null ? ref5.language : void 0 : void 0 : void 0) === "" || (runner != null ? (ref6 = runner.configuration) != null ? (ref7 = ref6.options) != null ? ref7.language : void 0 : void 0 : void 0) === void 0 || (runner != null ? (ref8 = runner.configuration) != null ? (ref9 = ref8.options) != null ? ref9.language : void 0 : void 0 : void 0) === "nodejs") {
      globs = [].concat(runner != null ? (ref10 = runner.configuration) != null ? (ref11 = ref10.options) != null ? ref11.hookfiles : void 0 : void 0 : void 0);
