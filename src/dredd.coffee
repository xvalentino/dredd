...
class Dredd
  ...
  emitStart: (callback) ->
    ...
    console.log 'reporter count', reporterCount
    ...
    @configuration.emitter.emit 'start', @configuration.data, (reporterError) =>
      reporterCount--
      console.log 'reporterError', reporterError if reporterError
      console.log 'processing listener function'
      console.log 'current reporter count', reporterCount
  ...
  startRunner: (callback) ->
    console.log 'starting runner after reporters'
